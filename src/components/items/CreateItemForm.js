...
const carFields = [
    ...
    {key: "colour", label: "Colour", type: "select",
     props: {required: true, items:[{label: "Silver", value: "silver", order: 1},
                                    ...
                                    {label: "Red", value: "red", order: 4},
                                    {label: "Yellow", value: "yellow", order: 5},
                                    {label: "Blue", value: "blue", order: 6},
                                    {label: "Green", value: "green", order: 7},
                                    {label: "Grey", value: "grey", order: 8},
                                    {label: "Other", value: "Other", order: 9},]}},
